...
var Search = function (_wx$Component) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Search.__proto__ || (0, _getPrototypeOf2.default)(Search)).call.apply(_ref, [this].concat(args))), _this), _this.app = getApp(), _this.data = (0, _extends3.default)({}, _this.app.globalData.data, {
      tabActive: 'search',
      list: [],
      search: {
        value: ""
  ...
  (0, _createClass3.default)(Search, [{
    ...
    value: function bindSearch(e) {
      ...
      _api2.default.search(keyword, 1).then(function (data) {
        _this3.setData({
          paged: 1,
          list: data.song
        });
