...
var List = function (_wx$Component) {
  ...
  function List() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = List.__proto__ || (0, _getPrototypeOf2.default)(List)).call.apply(_ref, [this].concat(args))), _this), _this.app = getApp(), _this.data = (0, _extends3.default)({}, _this.app.globalData.data, {
      tabActive: 'rank',
      list: [],
      board: {},
      paged: 1,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.loading(true);
                _context.next = 3;
                return _api2.default.getOnline(option.type, 1);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.loading(true);
                _context2.next = 4;
                return _api2.default.getOnline(this.data.type, paged);
              ...
              case 4:
                ...
                this.setData({
                  paged: paged,
                  list: [].concat((0, _toConsumableArray3.default)(this.data.list), (0, _toConsumableArray3.default)(data.song_list)),
                  loading: false
                });
